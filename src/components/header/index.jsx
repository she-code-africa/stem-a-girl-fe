    ...
    <div className="bg-[#FFB8E0] relative">
      <div className=" w-[90%] max-w-[1280px] flex py-6 md:py-16 container mx-auto max-md:flex-col justify-between max-xl:px-4">
        <div className="max-w-[578px] space-y-2">
          ...
          <div className="flex">
            <h1 className="text-[#B70569] text-[40px] leading-[50px] md:text-[32px] md:leading-[42px] max-w-[600px] lg:text-[60px] lg:leading-[72.8px] font-semibold">
        ...
        <div className="relative max-md:hidden">
          ...
          />
          <img src={homePageHeroImage} alt="" className="w-full max-h-[80vh] object-contain" />
        </div>
      </div>
